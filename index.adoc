...
* Welcome!
* **No Lab March 6**
* link:assts/asst05.html[Assignment 05: Userthreads] due Sunday March 2. 
* link:questions-week07.txt[Written Questions Due March 4th]
* **Midterm I**: 1.5 hours in class March 6. Closed Book. One cheatsheet. link:studyguide1.html[Study Guide I]
