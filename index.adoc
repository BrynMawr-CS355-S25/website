...
* Welcome!
* link:assts/asst01.html[Assignment 01] is due January 24th
...
| Office Hours - Prof. Aline Normoyle | Park 200B | Thursdays, 4-5 PM; Fridays TBD (Zoom)
| Office Hours - Paprika Chen | Park 231 | TBD
