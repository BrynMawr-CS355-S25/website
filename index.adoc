...
* link:assts/asst02.html[Assignment 02] is due Sunday Feb 2: Trust the Process (Part 1)
* link:assts/asst03.html[Assignment 03] is due Sunday Feb 9: Trust the Process (Part 2)
* Written Questions (Due Feb 10 in class, Be Brief!): link:questions-week04.txt[Written Questions]
...
|===
|30% | Exams
|55% | Assignments, projects, oral exam
|10% | Written homeworks and discussions
| 5% | Participation
|===
