...
* Welcome!
* link:labs/lab03.html[Lab Feb 13]: Code due Thursday Feb 13 5pm
* link:assts/asst04.html[Assignment 04] is due Sunday Feb 16: Trust the Process (Part 3)
* Written Questions (Due Feb 11 in class, Be Brief!): link:questions-week04.txt[Written Questions]
