...
Clone the repository from link:https://github.com/BrynMawr-CS355-S25[https://github.com/BrynMawr-CS355-S25]: 

[source, subs="attributes"]
----
git clone git@github.com:BrynMawr-CS355-S25/<USERNAME>-cs355-{semester}-assignments[]
----
...
In the directory `{ASST}`, you will have a sample file, `hello.cpp` and makefile `Makefile`. Try building and running.
...
In the directory, `{ASST}`, implement a program that inputs a binary file and outputs its contents as a hexadecimal string. 
