...
:Date:    2020-08-15
:Revision: 0.1
:ASST: threads-USERNAME

= {title}

**Milestone 1: Due Thursday, February 27, in lab (no extensions)**
**Due Sunday, March 2, before midnight**
...
NOTE: We will use new starter code: link:https://classroom.github.com/a/K88AA1Zs
...
The final deliverable (March 2) must add:
...
** return value: Upon success, thread_join should return 0 (this includes, of course, the case where the thread is already finished). If given a bad ID or if any other failure ocurres, thread_join should return -1.  Scheduling
...
* (4 points) Userthread
** (1.0 points) Thread API/Logging/Valgrind
** (0.6 points) FIFO 
** (0.7 points) SJF 
** (0.8 points) Priority 
** (0.6 points) Test Suite
